...
public class CompareProductList extends BaseClass {
	
	@Test
	public void compareProductList() throws EncryptedDocumentException, IOException {
		...
		dwsShirtPage.getAddToCompareList().click();
		//dwsShirtPage.getCompareProductsListLinkText().click();
		dwsCompareProductsPage = new DemoWebShopCompareProductsPage(driver);
		dwsCompareProductsPage.getClearListLinkText().click();
