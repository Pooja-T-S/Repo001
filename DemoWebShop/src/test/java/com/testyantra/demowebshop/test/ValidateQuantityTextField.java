...
public class ValidateQuantityTextField extends BaseClass {
	
	@Test
	public void validateQuantityTextField() throws EncryptedDocumentException, IOException, InterruptedException {
		...
		//Thread.sleep(3000);
		dwsApparelAndShoesPage.getApparelAddToCart().click();
		//Thread.sleep(3000);
