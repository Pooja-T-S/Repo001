...
public class DownloadInvoice extends BaseClass {
	...
	@Test
	public void downloadInvoice() throws EncryptedDocumentException, IOException {
		...
		dwsHomePage.getOrdersLinkText().click();
		dwsOrdersPage = new DemoWebShopOrdersPage(driver);
		dwsOrdersPage.getOrderDetailsButton().click();
		dwsOrdersPage.getPdfInvoiceButton().click();
