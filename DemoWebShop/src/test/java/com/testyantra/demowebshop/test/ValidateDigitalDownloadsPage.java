...
public class ValidateDigitalDownloadsPage extends BaseClass {
	
	@Test
	public void validateDigitalDownloadsPage() throws EncryptedDocumentException, IOException {
		...
		if(driver.getCurrentUrl().contains(excelUtils.readStringData("testcasedata",11, 1))) {
			Reporter.log("DigitalDownloadsPage is displayed upon verification of URL.");
		}
		else {
			Reporter.log("DigitalDownloadsPage is not displayed upon verification of URL.");
		}
