...
public class RemoveFromCart extends BaseClass {
	...
	@Test
	public void removeFromCart() throws EncryptedDocumentException, IOException {
		...
		dwsBooksPage.getFictionLinkText().click();
		...
		dwsCartPage.getremoveFromCartCheckBox().click();
		dwsCartPage.getUpdateShoppingCartButton().click();
